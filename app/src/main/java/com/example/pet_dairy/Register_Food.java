...
public class Register_Food extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter1 = new food_Adapter(listFood);
        ...
        add1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View view1 = LayoutInflater.from(Register_Food.this).inflate(R.layout.register__food, null, false);
                ...
                final Spinner Person = view1.findViewById(R.id.spnPer);
